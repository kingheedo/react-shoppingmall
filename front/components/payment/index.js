...
const Index = ({checkedProducts}) => {
  ...
  const onClickRequest = () => {
    window.BootPay.request({
      ...
      name: finalPurchaseProductsList.length >=2 ? `${finalPurchaseProductsList[0].name}외  ${finalPurchaseProductsList.length-1}` : finalPurchaseProductsList[0].name, //결제창에서 보여질 이름
      pg: 'kcp',
