...
// const Index = ({checkedProductsList}) => {
//   const {userCart,cartTotalPrice} = useSelector(state => state.cart)
...
//     const itemList = checkedProductsList.map(
//       item => ({
//         item_name: item.Product.productName,
//         qty: item.quantity, //수량
//         unique: item.id.toString(), //해당 상품을 구분짓는 primary key
//         price: item.Product.price, //상품 단가
//       }
//       )
//     )
//     console.log('itemList',itemList)
//     window.BootPay.request({
//       price: cartTotalPrice, //실제 결제되는 가격
//       application_id: "59a4d323396fa607cbe75de4",
//       name: checkedProductsList.length >=2 ? `${checkedProductsList[0].Product.productName}외  ${checkedProductsList.length-1}개` : checkedProductsList[0].Product.productName, //결제창에서 보여질 이름
//       pg: 'kcp',
...
//         // phone: '010-1234-4567'
//       },
//       order_id: `${me.id}_${new Date().getTime()}`, //고유 주문번호로, 생성하신 값을 보내주셔야 합니다.
...
//     <div className="box">
//       {checkedProductsList[0] 
//       ? 
//       <button  onClick={onClickRequest}>주문하기</button> 
//       : 
